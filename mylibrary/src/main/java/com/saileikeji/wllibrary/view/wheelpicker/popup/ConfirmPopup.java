package com.saileikeji.wllibrary.view.wheelpicker.popup;
...
import com.saileikeji.wllibrary.util.ConvertUtils;
...
public abstract class ConfirmPopup<V extends View> extends BottomPopup<View> {
    ...
    protected int cancelTextColor = Color.parseColor("#ff146ed2");
    protected int submitTextColor = Color.parseColor("#ff146ed2");;
    protected int titleTextColor = Color.parseColor("#ff146ed2");;
