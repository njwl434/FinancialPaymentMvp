...
/**
 * @describe: MoneyView 金额专用控件
 * @author: 武梁
 * @date: 2017/11/20 23:26
 * @mailbox: 1034905058@qq.com
 */
public class MoneyView extends View {
    private boolean mIsGroupingUsed,mIsGroupingJiacu; //是否开启 千分符 加粗
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        mIsGroupingJiacu = typedArray.getBoolean(R.styleable.MoneyView_jiacu, false);
        typedArray.recycle();
    ...
    public void setMoneyText(String string) {
        //强制转成2位x
        mMoneyText = df.format(Double.valueOf(string));
        requestLayout();
        postInvalidate();
    }
