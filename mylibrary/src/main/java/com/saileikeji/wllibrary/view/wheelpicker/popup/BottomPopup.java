...
public abstract class BottomPopup<V extends View> implements DialogInterface.OnKeyListener {
    ...
    public BottomPopup(Activity activity) {
        ...
        DisplayMetrics displayMetrics = DensityUtil.displayMetrics(activity);
    ...
    private void onShowPrepare() {
        ...
        LogUtil.e("do something before popup show");
        if (width == 0 && height == 0) {
    ...
    public void setOnDismissListener(DialogInterface.OnDismissListener onDismissListener) {
        ...
        LogUtil.e("popup setOnDismissListener");
    }
