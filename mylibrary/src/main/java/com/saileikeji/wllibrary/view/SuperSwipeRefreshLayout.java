...
public class SuperSwipeRefreshLayout extends ViewGroup {
    private static final String LOG_TAG = "SUSwipeRefreshLayout";
...
////                    return true;
////                }
////                if (lastChildBottom == mTarget.getHeight()){
////                    return  true;
////                }
//                int a = recyclerView.computeVerticalScrollExtent() + recyclerView.computeVerticalScrollOffset();
//                int b = recyclerView.computeVerticalScrollRange();
//                LogUtil.e(a+"");
//                LogUtil.e(b+"");
//                if (a >= b){
//                    return true;
...
//        }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        if (!isEnabled() || mReturningToStart || mRefreshing || mLoadMore
            ...
            LogUtil.e(!isEnabled()+"");
            LogUtil.e(mReturningToStart+"");
            LogUtil.e(mRefreshing+"");
            LogUtil.e(mLoadMore+"");
            LogUtil.e(!isChildScrollToTop()+"");
            LogUtil.e(!isChildScrollToBottom()+"");
