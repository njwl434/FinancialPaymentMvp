package com.saileikeji.wllibrary.view.wheelpicker.picker;
...
import com.saileikeji.wllibrary.util.DateUtils;
import com.saileikeji.wllibrary.view.wheelpicker.widget.WheelView;
...
public class TimePicker extends WheelPicker {
     ...
     *   显示时分秒
     */
    public static final int HOUR_MINUTE_SECOND = 2;
    private OnTimePickListener onTimePickListener;
    private int mode;
    private String hourLabel = "时", minuteLabel = "分",secondLable = "秒";
     ...
     */
    @IntDef(flag = false, value = {HOUR_OF_DAY, HOUR,HOUR_MINUTE_SECOND})
    ...
    protected View makeCenterView() {
        ...
        WheelView secondeView = new WheelView(activity);
        secondeView.setLayoutParams(new LinearLayout.LayoutParams(WRAP_CONTENT, WRAP_CONTENT));
        secondeView.setTextSize(textSize);
        secondeView.setTextColor(textColorNormal, textColorFocus);
        secondeView.setLineVisible(lineVisible);
        secondeView.setLineColor(lineColor);
        secondeView.setOffset(offset);
        layout.addView(secondeView);
        ...
        if (!TextUtils.isEmpty(secondLable)) {
            secondTextView.setText(secondLable);
        }
        layout.addView(secondTextView);
        if (mode==HOUR || mode == HOUR_OF_DAY){
            secondeView.setVisibility(View.GONE);
        ...
        secondeView.setItems(seconds,selectedSecond);
        ...
        secondeView.setOnWheelViewListener(
