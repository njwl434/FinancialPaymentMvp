package com.saileikeji.wllibrary.view.wheelpicker.widget;
...
public class WheelView extends ScrollView {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        LogUtil.i("w: " + w + ", h: " + h + ", oldw: " + oldw + ", oldh: " + oldh);
        viewWidth = w;
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                LogUtil.i(String.format("items=%s, offset=%s", items.size(), offset));
                LogUtil.i("selectedIndex=" + selectedIndex);
                float delta = ev.getY() - previousY;
                LogUtil.i("delta=" + delta);
    ...
    private class ScrollerTask implements Runnable {
        ...
        public void run() {
            ...
            if (initialY - newY == 0) { // stopped
                ...
                LogUtil.i("initialY: " + initialY + ", remainder: " + remainder + ", divided: " + divided);
                if (remainder == 0) {
