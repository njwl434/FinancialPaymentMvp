...
//        	throw new NullPointerException("You can add drawableRight attribute in XML");
            ...
            mClearDrawable.setBounds(0, 0, DensityUtil.dip2px(getContext(), 13), DensityUtil.dip2px(getContext(), 13));
        }
...
//            drawableLeft.setBounds(0, 0, DensityUtil.dip2px(getContext(), 13), DensityUtil.dip2px(getContext(), 13));
        }
//        this.setCompoundDrawablesWithIntrinsicBounds(drawableLeft, null, mClearDrawable, null);
        this.setCompoundDrawables(drawableLeft,null,mClearDrawable,null);
        //默认设置隐藏图标
...
//        this.setCompoundDrawablesWithIntrinsicBounds(drawableLeft, null, right, null);
        this.setCompoundDrawables(drawableLeft,null,right,null);
    }
