package com.saileikeji.ebangren.widgit.dbhelper;
...
public class AllCitySqliteOpenHelper extends SQLiteOpenHelper {
	...
	private static String DB_PATH = "/data/data/com.saileikeji.honghuahui/databases/";
	...
	public void createDataBase() throws IOException {
		...
		String dirPath="/data/data/"+mContext.getPackageName()+"/databases/";
		DB_PATH=dirPath;
		...
		if (dbExist) {
			...
			try {
				...
				String sfile = getDatabaseFile(DB_NAME);
				//通过openOrCreateDatabase方法将assets目录下的数据库，创建到系统默认的地方
				SQLiteDatabase.openOrCreateDatabase(sfile, null);
...
// 通过管理对象获取数据库
		checkDB = mg.getDatabase(DB_NAME);
