...
import com.saileikeji.ebangren.adapter.CityListAdapter;
import com.saileikeji.ebangren.adapter.SearchResultAdapter;
import com.saileikeji.ebangren.bean.City;
import com.saileikeji.ebangren.ui.base.BaseActivity;
import com.saileikeji.ebangren.widgit.MyLetterView;
import com.saileikeji.ebangren.widgit.dbhelper.AllCitySqliteOpenHelper;
import com.saileikeji.ebangren.widgit.dbhelper.AssetsDatabaseManager;
import com.saileikeji.ebangren.widgit.dbhelper.CitySqliteOpenHelper;
...
public class LocationActivity extends BaseActivity {
    ...
    private List<City> allCityList=new ArrayList<>();//所有的城市
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.acivity_location);
...
// 通过管理对象获取数据库
            SQLiteDatabase checkDB = mg.getDatabase("meituan_cities.db");
            cursor=checkDB.rawQuery("select * from city",null);
//            checkDB.execSQL("select * from city",null);
